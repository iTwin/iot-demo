...
Welcome, and thank you for your interest in contributing to iTwin IoT demo!
...
Before you create a new issue, please do a search in [open issues](https://github.com/iTwin/iot-demo/issues) to see if the issue or feature request has already been filed.
...
- Impact of the issue
- Use the [`bug`](https://github.com/iTwin/iot-demo/labels/bug) or [`enhancement`](https://github.com/iTwin/iot-demo/labels/enhancement) label to identify the type of issue you are filing
